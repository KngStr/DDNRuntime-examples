//----------------------------------------------------------------------------
//  System.Net.NameResolution.dll: System.Net.NameResolution, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
//----------------------------------------------------------------------------
...
{ objects }
  ...
  ['{3E0B370F-4F94-5890-90BB-CF6321248E90}']
  { static methods } 
  ...
  ['{428BA3A3-3895-32B5-8E94-388ACF0FAF74}']
  { methods } 
  ...
  ['{4E183783-EA05-57CE-B3AC-AB46D2A8460D}']
  { constructors } 
  ...
  ['{8FBCAFBC-BAE9-31D0-BB4E-5002FA93AAC0}']
  { getters & setters } 
...
initialization
  LoadAssemblyModule('System.Net.NameResolution.dll', True, 'System.Net.NameResolution, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a');
