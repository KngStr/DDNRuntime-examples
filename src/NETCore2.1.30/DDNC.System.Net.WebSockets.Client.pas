//----------------------------------------------------------------------------
//  System.Net.WebSockets.Client.dll: System.Net.WebSockets.Client, Version=4.1.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
//----------------------------------------------------------------------------
...
{ objects }
  ...
  ['{06672944-27C9-5063-B107-441FA00F04D6}']
  end;
  ...
  ['{D21B5F68-FD91-3405-8E55-EFB0F98C20C5}']
  { getters & setters } 
  ...
  ['{72D5CAAE-63F6-5C93-9854-F4AFBFD532F4}']
  { constructors } 
  ...
  ['{D8671334-4263-3FFE-AF4D-D1A077E3C9EF}']
  { getters & setters } 
