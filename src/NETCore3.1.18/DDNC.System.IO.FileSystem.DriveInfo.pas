//----------------------------------------------------------------------------
//  System.IO.FileSystem.DriveInfo.dll: System.IO.FileSystem.DriveInfo, Version=4.1.2.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
//----------------------------------------------------------------------------
...
{$IFNDEF DDNCSYSTEMIOFILESYSTEMDRIVEINFO}
...
{ objects }
  ...
  ['{20511916-1480-5A23-82EF-C1CE3B7AA081}']
  { constructors } 
  ...
  ['{306D6065-6B64-3141-8223-58C5B788EDBF}']
  { getters & setters } 
  ...
  ['{72DD07BF-F254-5CA2-B69B-C93449677963}']
  { constructors } 
  ...
  ['{AA793E9D-AFD0-31D4-8B68-988D8D2BBEC3}']
  { getters & setters } 
...
initialization
  LoadAssemblyModule('System.IO.FileSystem.DriveInfo.dll', True, 'System.IO.FileSystem.DriveInfo, Version=4.1.2.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a');
