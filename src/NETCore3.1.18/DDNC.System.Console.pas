//----------------------------------------------------------------------------
//  System.Console.dll: System.Console, Version=4.1.2.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
//----------------------------------------------------------------------------
...
{ objects }
  ...
  ['{5BF19A90-407A-5D30-898F-38214500B136}']
  ...
  ['{0EE9B21F-96FD-3B65-BE30-318ACBE648AB}']
  { events } 
  ...
  ['{5E100F51-8967-5938-9005-7744D373B66C}']
  { constructors } 
  ...
  ['{03E0BEBB-14EB-377A-B735-B9D896AEEC56}']
  { getters & setters } 
...
initialization
  LoadAssemblyModule('System.Console.dll', True, 'System.Console, Version=4.1.2.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a');
