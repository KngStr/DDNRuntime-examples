//----------------------------------------------------------------------------
//  System.Net.Security.dll: System.Net.Security, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
//----------------------------------------------------------------------------
...
{ declares }
  ...
  DNSslStreamCertificateContext = interface; // type: System.Net.Security.SslStreamCertificateContext, namespace: System.Net.Security
  ...
  DNSslClientHelloInfo = interface; // type: System.Net.Security.SslClientHelloInfo, namespace: System.Net.Security
...
{ delegates }
  ...
  [DNTypeName('System.Net.Security.ServerOptionsSelectionCallback')]
  DNServerOptionsSelectionCallback = function(stream: DNSslStream; clientHelloInfo: DNSslClientHelloInfo; state: DDNC.System.Private.CoreLib.DNObject; cancellationToken: DDNC.System.Private.CoreLib.DNCancellationToken): DDNC.System.Private.CoreLib.DNValueTask<DNSslServerAuthenticationOptions> of object;
...
{ objects }
  ...
  ['{B7F014A5-BA91-51F3-928D-A25D1D93F776}']
  { constructors } 
  ...
  ['{3A09024C-BD03-3457-AEE7-A752F1610023}']
  { getters & setters } 
  ...
  ['{74559CAB-947F-561A-8085-1E0C95CA647B}']
  { constructors } 
  ...
  ['{26BB2809-FA20-338F-96C9-EA3D84408F5A}']
  { getters & setters } 
  ...
  ['{9A40ECEE-A628-5F4C-BE1B-A0D76B02B9DD}']
  { constructors } 
  ...
  ['{6A055215-B01E-3AB2-ADC2-3D64C1969E25}']
  { getters & setters } 
  ...
  ['{66F98137-40CC-5FBC-AAFD-C7B362B3B887}']
  { constructors } 
  ...
  ['{43164967-B619-3938-9C01-86D8E296B57D}']
  { getters & setters } 
  ...
  { methods } 
    ...
    function BeginAuthenticateAsClient(credential: DDNC.System.Net.Primitives.DNNetworkCredential; targetName: string; requiredProtectionLevel: DNProtectionLevel; allowedImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel; asyncCallback: DDNC.System.Private.CoreLib.DNAsyncCallback; asyncState: DDNC.System.Private.CoreLib.DNObject): DDNC.System.Private.CoreLib.DNIAsyncResult; overload;
    ...
    procedure AuthenticateAsServer(credential: DDNC.System.Net.Primitives.DNNetworkCredential; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel); overload;
    procedure AuthenticateAsServer(credential: DDNC.System.Net.Primitives.DNNetworkCredential; policy: DNExtendedProtectionPolicy; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel); overload;
    ...
    function BeginAuthenticateAsServer(credential: DDNC.System.Net.Primitives.DNNetworkCredential; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel; asyncCallback: DDNC.System.Private.CoreLib.DNAsyncCallback; asyncState: DDNC.System.Private.CoreLib.DNObject): DDNC.System.Private.CoreLib.DNIAsyncResult; overload;
    function BeginAuthenticateAsServer(credential: DDNC.System.Net.Primitives.DNNetworkCredential; policy: DNExtendedProtectionPolicy; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel; asyncCallback: DDNC.System.Private.CoreLib.DNAsyncCallback; asyncState: DDNC.System.Private.CoreLib.DNObject): DDNC.System.Private.CoreLib.DNIAsyncResult; overload;
    ...
    procedure AuthenticateAsClient(credential: DDNC.System.Net.Primitives.DNNetworkCredential; targetName: string; requiredProtectionLevel: DNProtectionLevel; allowedImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel); overload;
    procedure AuthenticateAsClient(credential: DDNC.System.Net.Primitives.DNNetworkCredential; binding: DDNC.System.Net.Primitives.DNChannelBinding; targetName: string; requiredProtectionLevel: DNProtectionLevel; allowedImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel); overload;
    ...
    function AuthenticateAsClientAsync(credential: DDNC.System.Net.Primitives.DNNetworkCredential; targetName: string; requiredProtectionLevel: DNProtectionLevel; allowedImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel): DDNC.System.Private.CoreLib.DNTask; overload;
    ...
    function AuthenticateAsServerAsync(credential: DDNC.System.Net.Primitives.DNNetworkCredential; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel): DDNC.System.Private.CoreLib.DNTask; overload;
    function AuthenticateAsServerAsync(credential: DDNC.System.Net.Primitives.DNNetworkCredential; policy: DNExtendedProtectionPolicy; requiredProtectionLevel: DNProtectionLevel; requiredImpersonationLevel: DDNC.System.Private.CoreLib.DNTokenImpersonationLevel): DDNC.System.Private.CoreLib.DNTask; overload;
    procedure SetLength(value: Int64);
    function Seek(offset: Int64; origin: DDNC.System.Private.CoreLib.DNSeekOrigin): Int64;
    procedure Flush;
    function FlushAsync(cancellationToken: DDNC.System.Private.CoreLib.DNCancellationToken): DDNC.System.Private.CoreLib.DNTask; overload;
  ...
  ['{DD44373B-E956-5765-8D15-B12CE0CD9B1C}']
  { constructors } 
  ...
  ['{9AEB8B7E-CC61-3816-9DCC-0F955D1744C0}']
  { getters & setters } 
    ...
    function get_TargetHostName: string;
    function get_CanSeek: Boolean;
    function get_CanRead: Boolean;
    function get_CanTimeout: Boolean;
    function get_CanWrite: Boolean;
  ...
  { methods } 
    ...
    procedure AuthenticateAsClient(sslClientAuthenticationOptions: DNSslClientAuthenticationOptions); overload;
    ...
    procedure AuthenticateAsServer(sslServerAuthenticationOptions: DNSslServerAuthenticationOptions); overload;
    ...
    function AuthenticateAsServerAsync(optionsCallback: DNServerOptionsSelectionCallback; state: DDNC.System.Private.CoreLib.DNObject; cancellationToken: DDNC.System.Private.CoreLib.DNCancellationToken): DDNC.System.Private.CoreLib.DNTask; overload;
  ...
  { propertys } 
    ...
    property TargetHostName: string read get_TargetHostName;
    property CanSeek: Boolean read get_CanSeek;
    property CanRead: Boolean read get_CanRead;
    property CanTimeout: Boolean read get_CanTimeout;
    property CanWrite: Boolean read get_CanWrite;
  ...
  ['{745DBD91-DB95-53B6-8357-98EC39902D8A}']
  { constructors } 
  ...
  ['{014E9CD6-543D-3C17-B4D9-CE0377ED90A9}']
  { getters & setters } 
  ...
  ['{6D319DE9-7FF1-5A8F-972E-2F7D5507B65F}']
  { constructors } 
  ...
  ['{CCD8D32C-FB11-3661-BBD9-EF3B6FB8F358}']
  { getters & setters } 
  ...
  ['{04B0CFE3-43D4-5598-BAC0-CBD4507A95B0}']
  { constructors } 
  ...
  ['{889F1DF2-67D0-3793-9E29-654D1A95A099}']
  { getters & setters } 
    ...
    function get_ServerCertificateContext: DNSslStreamCertificateContext;
    procedure set_ServerCertificateContext(value: DNSslStreamCertificateContext);
    function get_EnabledSslProtocols: DDNC.System.Net.Primitives.DNSslProtocols;
    procedure set_EnabledSslProtocols(value: DDNC.System.Net.Primitives.DNSslProtocols);
    function get_CertificateRevocationCheckMode: DDNC.System.Security.Cryptography.X509Certificates.DNX509RevocationMode;
    procedure set_CertificateRevocationCheckMode(value: DDNC.System.Security.Cryptography.X509Certificates.DNX509RevocationMode);
  ...
  { propertys } 
    ...
    property ServerCertificateContext: DNSslStreamCertificateContext read get_ServerCertificateContext write set_ServerCertificateContext;
    property EnabledSslProtocols: DDNC.System.Net.Primitives.DNSslProtocols read get_EnabledSslProtocols write set_EnabledSslProtocols;
    property CertificateRevocationCheckMode: DDNC.System.Security.Cryptography.X509Certificates.DNX509RevocationMode read get_CertificateRevocationCheckMode write set_CertificateRevocationCheckMode;
    property EncryptionPolicy: DNEncryptionPolicy read get_EncryptionPolicy write set_EncryptionPolicy;
    property CipherSuitesPolicy: DNCipherSuitesPolicy read get_CipherSuitesPolicy write set_CipherSuitesPolicy;
  ...
  //-------------namespace: System.Net.Security----------------
  DNSslStreamCertificateContextClass = interface(DDNC.System.Private.CoreLib.DNObjectClass)
  ['{C8930036-EC4A-5A16-BF52-240AE1A8B73B}']
  { static methods } 

    {class} function Create(target: DDNC.System.Security.Cryptography.X509Certificates.DNX509Certificate2; additionalCertificates: DDNC.System.Security.Cryptography.X509Certificates.DNX509Certificate2Collection; offline: Boolean): DNSslStreamCertificateContext;

  end;

  [DNTypeName('System.Net.Security.SslStreamCertificateContext')]
  DNSslStreamCertificateContext = interface(DDNC.System.Private.CoreLib.DNObject)
  ['{5966FAF5-D9BC-3CA2-AC62-47294893D016}']
  { methods } 
  ...
  TDNSslStreamCertificateContext = class(TDNGenericImport<DNSslStreamCertificateContextClass, DNSslStreamCertificateContext>) end;

  //-------------namespace: System.Security.Authentication.ExtendedProtection----------------
  DNExtendedProtectionPolicyClass = interface(DNObjectClass)
  ['{FF7EA5E6-898F-55B1-A931-24321F72866C}']
  ...
  ['{568B7977-B4A4-31F6-B0DA-710F768EBD4E}']
  { getters & setters } 
  ...
  ['{59B62731-E6F9-53C8-B9FB-2BEE36A28313}']
  { constructors } 
  ...
  ['{EAAC2617-773C-329C-9153-64F850D1CF93}']
  { getters & setters } 
  ...
  //-------------namespace: System.Net.Security----------------
  DNSslClientHelloInfoClass = interface(DDNC.System.Private.CoreLib.DNValueTypeClass)
  ['{4E53603E-C446-505E-B9C4-24D423E40B19}']
  end;

  [DNTypeName('System.Net.Security.SslClientHelloInfo')]
  DNSslClientHelloInfo = interface(DDNC.System.Private.CoreLib.DNValueType)
  ['{6E8E2CD1-5663-3C7A-B3A8-C8F2612C11AC}']
  { getters & setters } 
  ...
  { propertys } 
    ...
    property SslProtocols: DDNC.System.Net.Primitives.DNSslProtocols read get_SslProtocols;
  end;

  TDNSslClientHelloInfo = class(TDNGenericImport<DNSslClientHelloInfoClass, DNSslClientHelloInfo>) end;
...
initialization
  LoadAssemblyModule('System.Net.Security.dll', True, 'System.Net.Security, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a');
